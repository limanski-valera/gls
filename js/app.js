(() => {
    ...
    const POPUPS_DATA = [ {
        ...
        content: `\n\t\t<strong>ГЛС Україна, Національний директор</strong>\n\t\t<p>\n\t\t\tГолова руху «Всі разом!» та аналітичного центру Кабінет експертів. Перший заступник головуючого Української Міжцерковної Ради.  Президент Асоціації журналістів «Новомедіа» та оргкомітету Новомедіа Форуму. Лідер національного руху «Всі разом – за сім’ю». У різні періоди є співробітником українських телеканалів, а також друкованих і електронних ЗМІ у якості репортера, парламентського кореспондента, випускового редактора, ведучого, головного редактора. Промовець, викладач, проповідник. Автор трьох книг — «Десятка», «Мандат», «Секс після контузії». Співавтор і редактор навчального посібника «Новий журналіст». Має журналістську, режисерську та богословську освіту. З дружиною Анною виховують п'ятьох дітей.\n\t\t</p>`
    } ];
    function initPopups() {
